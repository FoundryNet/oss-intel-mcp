...
def register(mcp) -> None:
    ...
    async def trending_repos(
        ...
        """Trending GitHub repositories with growth metrics (stars, forks, language,
        license) — optionally filtered by language or topic. Unfiltered queries are
        served from the daily-aggregated snapshot; filtered ones hit GitHub search
        live.
